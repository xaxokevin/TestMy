        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                if (index == 0){
                    ...
                    MyLog.d("idioma"," "+index);
                    String languageToLoad  = "es_ES"; // your language
                    Locale locale = new Locale(languageToLoad);
                    //RecycleCode.setLocale(locale,preference.getContext());
                    RecycleCode.setLocale2(languageToLoad,preference.getContext());
                    ...
                    MyLog.d("idioma"," "+index);
                    String languageToLoad  = "en_GB"; // your language
                    Locale locale = new Locale(languageToLoad);
                   //RecycleCode.setLocale(locale,preference.getContext());
                    RecycleCode.setLocale2(languageToLoad,preference.getContext());
